...
class CrossModalNet(nn.Module):
    def __init__(self, image_network_name='DenseNet', num_image_channels=1, num_csv_input_features=10, num_targets=1, pretrained_path='./model/resnet_18_23dataset.pth'):
        super().__init__()
    ...
    def forward(self, image_input, csv_input):
        ...
        if self.num_targets > 1:
            outputs = [head(fused_features) for head in self.regression_heads]
